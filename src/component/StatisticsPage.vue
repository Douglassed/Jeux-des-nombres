...
export default {
  ...
  methods : {
    fill : function () {
      this.gameList[0] = this.test
      this.gameList[1] = this.tested
    }
  }
}
</script>
